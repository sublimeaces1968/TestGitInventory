...
namespace linqTutorial
{
    class Program
    {
        ...
        {
            string[] dogs = { "K 9", "Brian Griffin", "Schooby Doo", "Old Yeller", "Rin Tin Tin", "Benji", "Charlie B. Barkin", "Lassie", "Snoopy" };
        ...
        static void QueryArrayList()
        {
            ...
            {
                Console.WriteLine("{0} weighs {1} in lbs", animal.Name, animal.Weight);
            }
        ...
        static void QueryCollection()
        {
            ...
            {
                Console.WriteLine("A {0} weighs {1} lbs0", dog.Name, dog.Weight);
            }
        ...
        static void QueryAnimalData()
        {
            Animal[] animals = new[]
            {
                ...
                new Animal{Name = "Chichuahua", Height = 7, Weight = 4.4, AnimalID = 2},
                new Animal{Name = "Saint Bernanrd", Height = 30, Weight = 200, AnimalID = 3},
